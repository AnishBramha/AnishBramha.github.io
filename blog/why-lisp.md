...
Why SICP is relevant here, you might ask. Well, after I picked up natural languages (and eventually made one) and before I picked up Crafting Interpreters, there was a summer break after my junior year. I actually tried studying SICP this time, with a more mature mind. This time, the exercises didn't seem that hard and I was able to digest the material. I also did find a proper local interpreter set-up (phew!). I came across concepts like the metacircular evaluator that Lisp is, what a type really means, what is an 'object', type dispatching and message passing. It was liberating to finally be able to understand the origins of various paradigms on programming. The book was more of an overview of the entire (mostly) field of computer science. It looks like some academician's dream of obscure bracket mania, but under the hype (is it still there?) lie these beautiful concepts, with an extremely intuitive exposition.
